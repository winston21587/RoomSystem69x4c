...
<tr>
    ...
    <td class="px-4 py-2 border-b border-gray-300"><button data-id="<?= $r['SchedID'] ?>">Edit</button></td>
    <td class="px-4 py-2 border-b border-gray-300"><button data-id="<?= $r['SchedID'] ?>">Delete</button></td>
</tr>
<?php endforeach; ?>
